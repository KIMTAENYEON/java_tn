...
-- 	values(1, '드니 빌뇌브', '1967.10.03', '캐나다', '영화감독, 시나리오작가'), 
--     (2, '티모시 샬라메', '1995.12.27', null, '배우'), 
--     (3, '레베카 퍼거슨', '1983.10.19', '스웨덴', '배우');

-- 영화 정보 추가 
-- insert into movie 
-- 	values(1, '듄', '12세 이상', 155, '2021.10.20', 
--     "“듄을 지배하는 자가 우주를 지배한다!”
...
-- 좌석 추가 
-- insert into seat(st_name, st_th_num, st_room_num)
-- 	values('A1', 1, 1),('A2', 1, 1),('A3', 1, 1),('A4', 1, 1),('A5', 1, 1),
...
-- 	values(1, 1, 1, '2021.12.01', '15:45', 1, '2D', 10, 10),
...
-- 	select 1, 'abc123', sc_num from `schedule` where sc_date = '2021-12-01' and sc_time = '21:20' and sc_room_num = 1;

-- 2. 예매 리스트에 데이터 추가 
-- insert into ticketing_list
-- 	select 1, 1, st_num from seat where st_room_num = 1 and st_name = 'A1';
-- insert into ticketing_list
-- 	select 2, 1, st_num from seat where st_room_num = 1 and st_name = 'A2';
