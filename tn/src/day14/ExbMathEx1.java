...
public class ExbMathEx1 {
	...
	public static void main(String[] args) {
		...
		/* double ceil(double a) : a를 소수점 자리에서 올림 (소수점자리가0이 아니면 올림)
		 * */
		System.out.println("3.1의 올림 : " + Math.ceil(3.1));
		System.out.println("3.1의 올림 : " + Math.ceil(-3.1));
		/* double floor(double a) : a를 소수점 자리에서 내림 (소수점자리가0이 아니면 내림)
		 * */
		System.out.println("3.1의 내림 : " + Math.floor(3.1));
		System.out.println("3.1의 내림 : " + Math.floor(-3.1));
		//int max(int a, int b) : a와 b 중 큰 수를 알려줌
		System.out.println("1과 5 중 큰 수 : " + Math.max(1, 5));
		System.out.println("1과 5 중 큰 수 : " + max(1, 5));
