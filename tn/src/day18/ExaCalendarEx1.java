...
public class ExaCalendarEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * */
		cal.set(Calendar.HOUR_OF_DAY, 14); //시간을 14로 설정
		...
		System.out.println("시 : " + cal.get(Calendar.HOUR));	//시	(12시)
		System.out.println("시 : " + cal.get(Calendar.HOUR_OF_DAY));	//시 (24시)
