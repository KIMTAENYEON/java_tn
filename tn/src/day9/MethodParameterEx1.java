...
public class MethodParameterEx1 {
	...
	public static int sum2(int [] nums)//매개변수 필수
	{
		int sum = 0;
		for(int i =0; i < nums.length; i++)
		{
	...
	/*public static void printInfo2(int grade, int classNum, int num, String ...nickname, String name)
	{
		
	}*/
	//p/129 가변 매개변수는 여러개 쓸 수 없음
	/*pubic static void printInfo3(int ... grade, String ...name)
	{
